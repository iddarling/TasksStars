    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="text-zinc-500 mt-2 font-medium tracking-wide">LEVEL UP YOUR LIFE</p>
        </div>
        ...
        <div className="text-center pt-4">
          <Link href="/register" className="text-zinc-500 hover:text-white transition-colors font-bold uppercase tracking-widest text-sm">
            NEW HERE? <span className="text-yellow-500 underline underline-offset-4 decoration-2 ml-1">REGISTER</span>
          </Link>
        </div>
      </div>
    </div>
